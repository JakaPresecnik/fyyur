...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:piko@localhost:5432/udacitydb2'
...
def search_venues():
  ...
  search_result = Venue.query.filter(Venue.name.ilike('%' + search_term +'%')).with_entities(Venue.id, Venue.name)
